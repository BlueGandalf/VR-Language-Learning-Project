...
public class CallTextbox : MonoBehaviour
{
    ...
    //this function is used to get the textbox, move it to the right place, put the right text on it, play the audio and log the interaction
    ...
    //this function logs the item interaction using the Shared function.
    ...
    //this function extracts the correct text from the database
    ...
    //this function extracts the correct translation text from the database
